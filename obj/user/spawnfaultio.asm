...
umain(int argc, char **argv)
{
  ...
  800068:	c3                   	ret    
		panic("spawn(faultio) failed: %e", r);
  800069:	50                   	push   %eax
  80006a:	68 c6 28 80 00       	push   $0x8028c6
  80006f:	6a 09                	push   $0x9
  800071:	68 e0 28 80 00       	push   $0x8028e0
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8000f7:	56                   	push   %esi
  8000f8:	50                   	push   %eax
  8000f9:	68 00 29 80 00       	push   $0x802900
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800263:	0f be 80 23 29 80 00 	movsbl 0x802923(%eax),%eax
  80026a:	50                   	push   %eax
...
008002b2 <vprintfmt>:
{
  ...
  80040c:	50                   	push   %eax
  80040d:	68 3b 29 80 00       	push   $0x80293b
  800412:	53                   	push   %ebx
  800413:	56                   	push   %esi
  ...
  800434:	b8 34 29 80 00       	mov    $0x802934,%eax
