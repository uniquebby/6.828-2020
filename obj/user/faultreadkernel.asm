	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001f0:	0f be 80 b1 22 80 00 	movsbl 0x8022b1(%eax),%eax
  8001f7:	50                   	push   %eax
...
0080023f <vprintfmt>:
{
  ...
  8002aa:	ff 24 85 00 24 80 00 	jmp    *0x802400(,%eax,4)
  ...
  800376:	8b 14 85 60 25 80 00 	mov    0x802560(,%eax,4),%edx
  80037d:	85 d2                	test   %edx,%edx
  80037f:	74 18                	je     800399 <vprintfmt+0x15a>
				printfmt(putch, putdat, "%s", p);
  800381:	52                   	push   %edx
  800382:	68 9a 26 80 00       	push   $0x80269a
  800387:	53                   	push   %ebx
  800388:	56                   	push   %esi
  ...
  800399:	50                   	push   %eax
  80039a:	68 c9 22 80 00       	push   $0x8022c9
  80039f:	53                   	push   %ebx
  8003a0:	56                   	push   %esi
  ...
  8003c1:	b8 c2 22 80 00       	mov    $0x8022c2,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800ac2:	68 bf 25 80 00       	push   $0x8025bf
  800ac7:	6a 23                	push   $0x23
  800ac9:	68 dc 25 80 00       	push   $0x8025dc
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800b85:	68 bf 25 80 00       	push   $0x8025bf
  800b8a:	6a 23                	push   $0x23
  800b8c:	68 dc 25 80 00       	push   $0x8025dc
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800bc7:	68 bf 25 80 00       	push   $0x8025bf
  800bcc:	6a 23                	push   $0x23
  800bce:	68 dc 25 80 00       	push   $0x8025dc
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800c8d:	68 bf 25 80 00       	push   $0x8025bf
  800c92:	6a 23                	push   $0x23
  800c94:	68 dc 25 80 00       	push   $0x8025dc
...
sys_ipc_recv(void *dstva)
{
  ...
  800cf1:	68 bf 25 80 00       	push   $0x8025bf
  800cf6:	6a 23                	push   $0x23
  800cf8:	68 dc 25 80 00       	push   $0x8025dc
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800e04:	8b 04 95 68 26 80 00 	mov    0x802668(,%edx,4),%eax
  ...
  800e1a:	51                   	push   %ecx
  800e1b:	50                   	push   %eax
  800e1c:	68 ec 25 80 00       	push   $0x8025ec
...
read(int fdnum, void *buf, size_t n)
{
  ...
  801074:	53                   	push   %ebx
  801075:	50                   	push   %eax
  801076:	68 2d 26 80 00       	push   $0x80262d
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80113b:	53                   	push   %ebx
  80113c:	50                   	push   %eax
  80113d:	68 49 26 80 00       	push   $0x802649
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  8011e3:	53                   	push   %ebx
  8011e4:	50                   	push   %eax
  8011e5:	68 0c 26 80 00       	push   $0x80260c
...
008013a5 <devfile_write>:
{
  ...
  8013ff:	eb b2                	jmp    8013b3 <devfile_write+0xe>
	  assert(r <= n_left);
  801401:	68 7c 26 80 00       	push   $0x80267c
  801406:	68 88 26 80 00       	push   $0x802688
  80140b:	68 9f 00 00 00       	push   $0x9f
  801410:	68 9d 26 80 00       	push   $0x80269d
  801415:	e8 6a 0a 00 00       	call   801e84 <_panic>
	  assert(r <= PGSIZE);
  80141a:	68 a8 26 80 00       	push   $0x8026a8
  80141f:	68 88 26 80 00       	push   $0x802688
  801424:	68 a0 00 00 00       	push   $0xa0
  801429:	68 9d 26 80 00       	push   $0x80269d
...
00801433 <devfile_read>:
{
  ...
  801488:	c3                   	ret    
	assert(r <= n);
  801489:	68 b4 26 80 00       	push   $0x8026b4
  80148e:	68 88 26 80 00       	push   $0x802688
  801493:	6a 7c                	push   $0x7c
  801495:	68 9d 26 80 00       	push   $0x80269d
  80149a:	e8 e5 09 00 00       	call   801e84 <_panic>
	assert(r <= PGSIZE);
  80149f:	68 a8 26 80 00       	push   $0x8026a8
  8014a4:	68 88 26 80 00       	push   $0x802688
  8014a9:	6a 7d                	push   $0x7d
  8014ab:	68 9d 26 80 00       	push   $0x80269d
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801572:	68 bb 26 80 00       	push   $0x8026bb
  801577:	53                   	push   %ebx
...
008015d2 <_pipeisclosed>:
{
  ...
  801615:	50                   	push   %eax
  801616:	53                   	push   %ebx
  801617:	68 c2 26 80 00       	push   $0x8026c2
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8018ae:	68 da 26 80 00       	push   $0x8026da
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  801c70:	c3                   	ret    
		assert(r < 1600 && r <= len);
  801c71:	68 e6 26 80 00       	push   $0x8026e6
  801c76:	68 88 26 80 00       	push   $0x802688
  801c7b:	6a 62                	push   $0x62
  801c7d:	68 fb 26 80 00       	push   $0x8026fb
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801cce:	c3                   	ret    
	assert(size < 1600);
  801ccf:	68 07 27 80 00       	push   $0x802707
  801cd4:	68 88 26 80 00       	push   $0x802688
  801cd9:	6a 6d                	push   $0x6d
  801cdb:	68 fb 26 80 00       	push   $0x8026fb
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801d1b:	68 13 27 80 00       	push   $0x802713
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801eb3:	e8 3a e2 ff ff       	call   8000f2 <vcprintf>
	cprintf("\n");
  801eb8:	c7 04 24 d3 26 80 00 	movl   $0x8026d3,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801f90:	68 44 27 80 00       	push   $0x802744
  801f95:	6a 35                	push   $0x35
  801f97:	68 74 27 80 00       	push   $0x802774
