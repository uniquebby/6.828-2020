...
sys_env_destroy(envid_t envid)
{
  ...
  800117:	68 8f 22 80 00       	push   $0x80228f
  80011c:	6a 23                	push   $0x23
  80011e:	68 ac 22 80 00       	push   $0x8022ac
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800198:	68 8f 22 80 00       	push   $0x80228f
  80019d:	6a 23                	push   $0x23
  80019f:	68 ac 22 80 00       	push   $0x8022ac
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001da:	68 8f 22 80 00       	push   $0x80228f
  8001df:	6a 23                	push   $0x23
  8001e1:	68 ac 22 80 00       	push   $0x8022ac
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80021c:	68 8f 22 80 00       	push   $0x80228f
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80025e:	68 8f 22 80 00       	push   $0x80228f
  800263:	6a 23                	push   $0x23
  800265:	68 ac 22 80 00       	push   $0x8022ac
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002a0:	68 8f 22 80 00       	push   $0x80228f
  8002a5:	6a 23                	push   $0x23
  8002a7:	68 ac 22 80 00       	push   $0x8022ac
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002e2:	68 8f 22 80 00       	push   $0x80228f
  8002e7:	6a 23                	push   $0x23
  8002e9:	68 ac 22 80 00       	push   $0x8022ac
...
sys_ipc_recv(void *dstva)
{
  ...
  800346:	68 8f 22 80 00       	push   $0x80228f
  80034b:	6a 23                	push   $0x23
  80034d:	68 ac 22 80 00       	push   $0x8022ac
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800459:	8b 04 95 38 23 80 00 	mov    0x802338(,%edx,4),%eax
  ...
  80046f:	51                   	push   %ecx
  800470:	50                   	push   %eax
  800471:	68 bc 22 80 00       	push   $0x8022bc
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8006c9:	53                   	push   %ebx
  8006ca:	50                   	push   %eax
  8006cb:	68 fd 22 80 00       	push   $0x8022fd
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  800790:	53                   	push   %ebx
  800791:	50                   	push   %eax
  800792:	68 19 23 80 00       	push   $0x802319
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800838:	53                   	push   %ebx
  800839:	50                   	push   %eax
  80083a:	68 dc 22 80 00       	push   $0x8022dc
...
008009fa <devfile_write>:
{
  ...
  800a54:	eb b2                	jmp    800a08 <devfile_write+0xe>
	  assert(r <= n_left);
  800a56:	68 4c 23 80 00       	push   $0x80234c
  800a5b:	68 58 23 80 00       	push   $0x802358
  800a60:	68 9f 00 00 00       	push   $0x9f
  800a65:	68 6d 23 80 00       	push   $0x80236d
  800a6a:	e8 6a 0a 00 00       	call   8014d9 <_panic>
	  assert(r <= PGSIZE);
  800a6f:	68 78 23 80 00       	push   $0x802378
  800a74:	68 58 23 80 00       	push   $0x802358
  800a79:	68 a0 00 00 00       	push   $0xa0
  800a7e:	68 6d 23 80 00       	push   $0x80236d
...
00800a88 <devfile_read>:
{
  ...
  800add:	c3                   	ret    
	assert(r <= n);
  800ade:	68 84 23 80 00       	push   $0x802384
  800ae3:	68 58 23 80 00       	push   $0x802358
  800ae8:	6a 7c                	push   $0x7c
  800aea:	68 6d 23 80 00       	push   $0x80236d
  800aef:	e8 e5 09 00 00       	call   8014d9 <_panic>
	assert(r <= PGSIZE);
  800af4:	68 78 23 80 00       	push   $0x802378
  800af9:	68 58 23 80 00       	push   $0x802358
  800afe:	6a 7d                	push   $0x7d
  800b00:	68 6d 23 80 00       	push   $0x80236d
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800bc7:	68 8b 23 80 00       	push   $0x80238b
  800bcc:	53                   	push   %ebx
...
00800c27 <_pipeisclosed>:
{
  ...
  800c6a:	50                   	push   %eax
  800c6b:	53                   	push   %ebx
  800c6c:	68 92 23 80 00       	push   $0x802392
...
devsock_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800f03:	68 aa 23 80 00       	push   $0x8023aa
...
nsipc_recv(int s, void *mem, int len, unsigned int flags)
{
  ...
  8012c5:	c3                   	ret    
		assert(r < 1600 && r <= len);
  8012c6:	68 b6 23 80 00       	push   $0x8023b6
  8012cb:	68 58 23 80 00       	push   $0x802358
  8012d0:	6a 62                	push   $0x62
  8012d2:	68 cb 23 80 00       	push   $0x8023cb
...
nsipc_send(int s, const void *buf, int size, unsigned int flags)
{
  ...
  801323:	c3                   	ret    
	assert(size < 1600);
  801324:	68 d7 23 80 00       	push   $0x8023d7
  801329:	68 58 23 80 00       	push   $0x802358
  80132e:	6a 6d                	push   $0x6d
  801330:	68 cb 23 80 00       	push   $0x8023cb
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  801370:	68 e3 23 80 00       	push   $0x8023e3
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8014f5:	56                   	push   %esi
  8014f6:	50                   	push   %eax
  8014f7:	68 f0 23 80 00       	push   $0x8023f0
  ...
  801508:	e8 56 00 00 00       	call   801563 <vcprintf>
	cprintf("\n");
  80150d:	c7 04 24 a3 23 80 00 	movl   $0x8023a3,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  801661:	0f be 80 13 24 80 00 	movsbl 0x802413(%eax),%eax
  801668:	50                   	push   %eax
...
008016b0 <vprintfmt>:
{
  ...
  8017f2:	52                   	push   %edx
  8017f3:	68 6a 23 80 00       	push   $0x80236a
  8017f8:	53                   	push   %ebx
  8017f9:	56                   	push   %esi
  ...
  80180a:	50                   	push   %eax
  80180b:	68 2b 24 80 00       	push   $0x80242b
  801810:	53                   	push   %ebx
  801811:	56                   	push   %esi
  ...
  801832:	b8 24 24 80 00       	mov    $0x802424,%eax
